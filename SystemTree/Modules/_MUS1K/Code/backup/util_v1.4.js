    ...
    switch (gridInterval.toString()) {
      ...
      case "0,0,1,0,0,2,0,0,0,0,0,0":  //*Triades Sus2 Sus4 e 4ths (dependente do Root)
        ...
        //Se não existir Root note definida:
          ...
          //Define a cor:
          if (Treatarray.compareArrays(chordInterval(ar),[ 5, 2, 5])) {color = ["Sus4", "Sus2", "4th"] };
          if (Treatarray.compareArrays(chordInterval(ar),[ 5, 5, 2])) {color = ["4th", "Sus4", "Sus2"] };
          if (Treatarray.compareArrays(chordInterval(ar),[ 2, 5, 5])) {color = ["Sus2", "4th", "Sus4"] };
        }
        break;
          ...
          if (Treatarray.compareArrays(tmp,[3,4,3,4,3,4,3])) { 
            ...
            if (errorCode == 1) {
              ...
              if (root == tmpnte[0] ) {
                ...
                //Define a nota:
                note[0] = notesSharp[ar[Mymath.mod(ar.length,r+1)]];
              ...
              //Define a nota:
              note[0] = notesSharp[ar[r]];
              note[1] = notesSharp[ar[Mymath.mod(ar.length,r+1)]];
          ...
          if (Treatarray.compareArrays(tmp,[3,4,4,3,3,4,3])) { 
            ...
            if (errorCode == 1) {
              ...
              if (root == tmpnte[0] ) {
                ...
                //Define a nota:
                note[0] = notesSharp[ar[Mymath.mod(ar.length,r+5)]];
              ...
              //Define a nota:
              note[0] = notesSharp[ar[r]];
              note[1] = notesSharp[ar[Mymath.mod(ar.length,r+5)]];
...
console.log(scale(1,"II","#",0))
console.log("o acorde é:",chord(array1, baixo )); 
//
//? ------------------------------------------------------------------------------------------------------
//? ------------------------------------------------------------------------------------------------------
